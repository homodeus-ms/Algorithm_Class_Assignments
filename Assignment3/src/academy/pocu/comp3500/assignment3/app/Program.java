    ...
    public static void main(String[] args) {
        {
            ...
            final boolean IS_BLACK_KEYBOARD_PLAYER = true; // true 라면 검은색 플레이어의 수를 콘솔에 입력해야 함

            final int MAX_MOVE_TIME_MILLISECONDS = 500; // Player 가 턴마다 수를 결정하는 데에 주어진 시간
            final long AUTO_PLAY_TURN_DURATION_IN_MILLISECONDS = 500; // Autoplay 중 턴마다 일시중지 되는 기간
